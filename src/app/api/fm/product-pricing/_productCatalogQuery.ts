...
export type ParsedProductCatalogQuery = {
...
export function parseProductIdsList(raw: string | null): number[] {
    if (!raw) return [];
    return Array.from(
        new Set(
            raw
...
export function parseProductCatalogQuery(searchParams: URLSearchParams): ParsedProductCatalogQuery {
