// src/app/api/fm/treasury/bulk-approval-v2/route.ts
import { NextRequest } from "next/server";
import { jsonResponse, serverErrorResponse } from "@/modules/financial-management/treasury/bulk-approval-v2/services/http";
import { createBulkApprovalContext, getApprovalContextsForUser, fetchUserMap } from "@/modules/financial-management/treasury/bulk-approval-v2/services/bulkApproval.shared";
import { handleFinalHeaderDecision, handleFinalTopSheetsGetResource } from "@/modules/financial-management/treasury/bulk-approval-v2/services/finalTopSheets.service";
import { handleMyLevelApprovalGetResource, submitMyLevelApprovalVote } from "@/modules/financial-management/treasury/bulk-approval-v2/services/myLevelApproval.service";
