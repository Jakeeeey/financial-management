...
export async function POST(request: NextRequest, props: { params: Promise<{ id: string }> }) {
    ...
    const targetUrl = `${getSpringBaseUrl()}/api/v1/collections/${collectionId}/allocate/partial`;
    ...
    try {
        ...
        if (!springRes.ok) {
            ...
            console.error(`[Spring Boot POST Partial Allocate Error] Status: ${springRes.status}`, errorText);
        ...
        console.error("[BFF POST Partial Allocate Exception]:", err);
