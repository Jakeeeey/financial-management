...
export async function GET(req: Request) {
    ...
    // Target the disbursement collection in Directus.
    const targetUrl = `${API_BASE_URL}/items/disbursement?${query.toString()}`;
    ...
    try {
        ...
        console.error("GET Disbursement Proxy Error:", err);
