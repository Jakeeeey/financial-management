...
import { PriceChangeMonitoringModule } from "@/modules/financial-management/product-pricing-management/price-change-monitoring";
                    ...
                    <div className="min-w-0 overflow-hidden">
                        <Breadcrumb>
                            <BreadcrumbList>
                                ...
                                <BreadcrumbItem>
                                    <BreadcrumbPage>Price Change Monitoring</BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
                    </div>
