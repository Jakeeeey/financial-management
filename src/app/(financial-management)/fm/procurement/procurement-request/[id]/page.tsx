...
import ProcurementRequestDetailPage from "@/modules/financial-management/procurement/procurement-request/components/ProcurementRequestDetailPage";
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="/fm/procurement/procurement-request">FM</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="/fm/procurement/procurement-request">Procurement Requests</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-2 sm:p-4">
                <ProcurementRequestDetailPage id={Number(id)} />
            </main>
        </div>
    );
}
