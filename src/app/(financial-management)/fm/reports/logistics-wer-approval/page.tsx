...
import LogisticsWerApprovalModule from "@/modules/financial-management/reports/logistics-wer-approval/LogisticsWerApprovalModule";
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <div className="flex h-full min-w-0 items-center gap-2 overflow-hidden px-3 sm:px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem className="hidden text-muted-foreground md:block"><BreadcrumbLink href="#">Reports</BreadcrumbLink></BreadcrumbItem>
              <BreadcrumbSeparator className="hidden md:block" />
              <BreadcrumbItem><BreadcrumbPage>Logistics WER Approval</BreadcrumbPage></BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-2 sm:p-4">
        <Suspense fallback={<p className="p-4 text-sm text-muted-foreground">Loading approval queue…</p>}>
          <LogisticsWerApprovalModule />
        </Suspense>
      </main>
    </div>
  );
