// src/app/(financial-management)/fm/accounting/discount-management/supplier-discounting/page.tsx
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
/**
 * Renders the supplier discounting page shell and server-loads module metadata.
 */
