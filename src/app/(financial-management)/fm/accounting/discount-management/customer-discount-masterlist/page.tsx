// src/app/(financial-management)/fm/accounting/discount-management/customer-discount-masterlist/page.tsx
...
import CustomerDiscountMasterlistModule from "@/modules/financial-management/accounting/discount-management/customer-discount-masterlist/CustomerDiscountMasterlistModule";

export const metadata: Metadata = {
  title: "Customer Discount Masterlist | Financial Management",
  description: "View customer discount configurations per supplier.",
};
...
export default async function CustomerDiscountMasterlistPage() {
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden">
        <CustomerDiscountMasterlistModule />
      </main>
    </div>
  );
}
