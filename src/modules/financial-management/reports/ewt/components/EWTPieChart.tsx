...
// Pie chart showing EWT distribution by supplier, with a scrollable dropdown legend.
  ...
  return (
    <Card className="shadow-none border-border">
      <CardHeader className="border-b border-border/50 pb-3">
        <CardTitle className="text-sm font-bold">EWT Distribution by Supplier</CardTitle>
      </CardHeader>
