...
function BudgetFeedbackDisplay({ 
  feedbacks, 
  isPendingTab = false 
}: { 
  feedbacks?: Array<{ id: string | number; status: string; feedback: string; voted_by_name: string; voted_at: string }> | null;
                ...
                <TableCell className="py-4">
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-start gap-3 mt-0.5">
                      ...
                      <BudgetFeedbackDisplay feedbacks={budget.feedbacks} isPendingTab={isPendingTab} />
                    </div>
                  </div>
                </TableCell>
