                        ...
                        <div className="bg-card p-5 rounded-xl border border-border shadow-sm grid grid-cols-2 gap-4">
                                ...
                                <div className="flex gap-2">
                                    <div className="flex-1 min-w-0">
                                        <SearchableDropdown<number>
                                            ...
                                            disabled={isHeaderLocked || loadingData || !transactionTypeId}
                                    ...
                                    {!isNonTradeVoucher && (
                                        <Button type="button" onClick={() => handleOpenPoModal()} disabled={isHeaderLocked || !payeeId}
                            ...
                            <div className="space-y-1.5 col-span-2">
                                ...
                                {supportingDocumentsUrl ? (
                                    ...
                                    <div className={cn(
                                        "relative border border-dashed border-border/70 rounded-xl p-4 hover:border-primary/50 transition-colors flex flex-col items-center justify-center gap-2 bg-muted/10",
                                        isHeaderLocked && "pointer-events-none opacity-60"
                                    )}>
                                        {uploadingFile ? (
                                            <>
