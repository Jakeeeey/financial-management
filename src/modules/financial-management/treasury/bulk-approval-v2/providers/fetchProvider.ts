// src/modules/financial-management/treasury/bulk-approval-v2/providers/fetchProvider.ts
"use client";
...
const BASE = "/api/fm/treasury/bulk-approval-v2";
...
export async function getFinalTopSheet(params: {
  ...
  if (params.header_id) {
    qs.append("header_id", String(params.header_id));
  }
