...
export const PaymentMethodDistribution = () => {
    const { detailedPaymentMethodData, formatCurrency } = useDailyCollectionReport();
            ...
            <CardHeader className="pb-3">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <CardDescription className="text-xs">Detailed breakdown of collection methods for the day</CardDescription>
                    </div>
                </div>
            </CardHeader>
            <Separator />
