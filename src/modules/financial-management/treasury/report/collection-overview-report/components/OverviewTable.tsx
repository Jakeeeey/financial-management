...
export const OverviewTable = () => {
    const { reportData, error, formatCurrency } = useCollectionOverview();
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <CardDescription className="text-xs">All collection records for selected range</CardDescription>
                        </div>
                    </div>
